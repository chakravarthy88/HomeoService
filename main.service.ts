...
export class MainService {
  ...
  getMyPatients() {
    ...
    this.patients = [];
    this.afStore
      .collection('Patients', ref => ref.where("RegisteredBy", "==", userId))
      .get()
      .subscribe(a => {
        a.forEach(aa =>
  ...
  sendToDoctor(appointment) {
    this.afStore.collection("Patients").doc(appointment.uid).set({
      ...
      BrethelessWeesing: appointment.BoBrethelessWeesing,
      ChestTightness: appointment.BoChestTightness,
      Cold: appointment.BoCold,
      Cough: appointment.BoCough,
      CoughtClipping: appointment.BoCoughtClipping,
      Diarrhoea: appointment.BoDiarrhoea,
      Drowsy: appointment.BoDrowsy,
      FeverWithChills: appointment.BoFeverWithChills,
      Nausea: appointment.BoNausea,
      Thirst: appointment.BoThirst,
      TieredRestless: appointment.BoTieredRestless
    })
  }
  ...
  buildAppointment(data, doc) {
    var appointmentInfo: Appointment = {
      ...
      SymptomDate: new Date(data.SymptomDate*1000),
      Symptoms: data.Symptoms,
      Temparature: data.Temparature,
      BodyPains: data.BodyPains,
      BrethelessWeesing: data.BoBrethelessWeesing,
      ChestTightness: data.BoChestTightness,
      Cold: data.BoCold,
      Cough: data.BoCough,
      CoughtClipping: data.BoCoughtClipping,
      Diarrhoea: data.BoDiarrhoea,
      Drowsy: data.BoDrowsy,
      FeverWithChills: data.BoFeverWithChills,
      Nausea: data.BoNausea,
      Thirst: data.BoThirst,
      TieredRestless: data.BoTieredRestless,
